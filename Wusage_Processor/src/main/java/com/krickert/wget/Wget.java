//From githun Kristian Rickert  https://github.com/krickert
...
public class Wget {
  ...
  public static WgetStatus wGet(String saveAsFile, String urlOfFile, String username, String password) {
	    InputStream httpIn = null;
	    OutputStream fileOutput = null;
	    OutputStream bufferedOut = null;
	    try {
