## Rob Wynne, LMCO
## Create a flat XML file from the Stability subset report.
## This is based on sample file NCI_Stability_Subsets.xml
...
my @codeTags = ("stability_definition", "nci_definition");
my @codeItemAttributes = ("nci_code", "nci_pt", "stab_pt");
my @subsetItemAttributes = ("subset_code", "subset_name");
...
#    print $row_max." ".$tagToCol{$subsetName}." ".$tagToCol{$thesaurusCode}."\n";
